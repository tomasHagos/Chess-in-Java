...
public class MyWorld extends World
{
 ...
 public void stopped(){
         int player;
        if(checkmated){
        showText("Game Over by CheckMate", 500,200);
        ...
        showText("Player"+ player +" Won", 500, 250);
        
        //setImage(new GreenfootImage("Player" + player + " Won", 15, playerColor, null, null));
